import { Badge, BadgeTheme, colorVars, GlyphIcon, HStack, Icon, spacingVars, StackAlign, Typo, VStack, Weight } from '@tapie-kr/inspire-react'
...
export default function AwardCard(props: AwardCardProps) {
  return <>
    <VStack spacing={spacingVars.micro} align={StackAlign.START}>
      <VStack spacing={spacingVars.optical} align={StackAlign.START}>
      ...
      <HStack spacing={spacingVars.mini} style={{ color: colorVars.content.default }}>
