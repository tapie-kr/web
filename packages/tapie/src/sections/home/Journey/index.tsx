  ...
  return <>
    <ViewportDetector once>
      <AnimateProvider
        ...
        hideOverflow
      >
        <VStack id='journey' className={s.section} gap={spacingVars.medium} align='center'>
          <Flex className={s.title} fullWidth gap={spacingVars.base} justify='between'>
            <Animate order={1}>
              <Typo.Jumbo weight={Weight.SEMIBOLD}>그동안 우리들의 여정</Typo.Jumbo>
            </Animate>
            <VStack className={s.viewMore} gap={spacingVars.moderate}>
              <Animate order={2}>
                <Typo.Moderate tag={Tag.P} color={colorVars.content.default} weight={Weight.MEDIUM}>
          ...
          <VStack className={s.marqueeGroup} gap={spacingVars.base}>
