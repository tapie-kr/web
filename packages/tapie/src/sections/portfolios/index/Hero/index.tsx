import { colorVars, spacingVars, StackAlign, Tag, Typo, VStack, Weight } from '@tapie-kr/inspire-react'
...
export default function PortfoliosHeroSection() {
  return <>
    <ContentSection maxWidth={1400} verticalPadding={spacingVars.jumbo}>
      <VStack spacing={spacingVars.medium} fullWidth align={StackAlign.START}>
        <VStack spacing={spacingVars.petite}align={StackAlign.START}>
