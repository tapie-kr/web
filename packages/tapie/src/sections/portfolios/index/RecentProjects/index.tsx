...
import { Badge, GlyphIcon, Icon, Typo, Weight } from '@tapie-kr/inspire-react'
    ...
    <GradientCard padding={Spacing.Moderate}>
      <VStack gap={Spacing.Tiny} data-theme='dark'>
        ...
        <HStack gap={Spacing.Base} align='end'>
          <Typo.Medium weight={Weight.SEMIBOLD} color={Color.Content.Emphasized}>프로젝트 이름</Typo.Medium>
          <HStack gap={Spacing.Mini} fitContent align='center'>
            <Typo.Base weight={Weight.MEDIUM} color={Color.Content.Default}>프로젝트 설명</Typo.Base>
